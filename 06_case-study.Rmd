...
This section gives the key particulars on how the sets and parameters above are defined from the SPC documentation. Further details are provided in Appendix [TODO: cross-ref]

[TODO: adapt Appendix from supplementary information (shann-gu-documentation/data.html)]

### Site layout

Site 
The parameters which define site layout in the PRaQ model are the distance between zones
