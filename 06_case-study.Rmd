...
tab.exergy.tex <- xtable(exergy,
			  caption="Results of exergy analysis for SPC scenarios; $\\alpha^{prod}_{ex} = 47$ MW for each scenario.\\label{tab:SPC-exergy}", digits=c(0,0,0,0),
			  align="llll")
