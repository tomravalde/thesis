...
Finally, in parallel to the above three improvements, the SPC planners could apply further sensitivity analysis. This case study has shown how the middle of the system responds to different objectives and the available set of conversion processes. But more sophisticate could look at changing demands (for example, to investigate the effect of populaiton growth, changing consumer behaviour, etc.), the cost of resources, and the cost of processes. In particular, it would be interesting to see how much change a particular system can bear before it becomes over-reliant on importing resources, and no longer achieves the metabolic efficiency objectives intended. This could extend into a more in depth study on system resilience [TODO: cite] .
