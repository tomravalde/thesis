...
Having detailed the data sources, assumptions, and calculations used to determine the model's parameters, PRaQ is now applied to eight scenarios (\ref{itm:base}--\ref{itm:wild-long}, below) to suggest how to satisfy SPC demand using different sets of available processes and objective functions:
