...
These four features usually trade off against one another, which means a model will usually be a compromise. Models that are more general will be lower fidelity, because they are not tailored to the specific details of a real-world [@McIntosh2012]. Models of higher fidelity are both less tractable and less usable, because of more advanced mathematics is required, and makes formalizing the model more difficult. The case study in this chapter will test three different formulations, and their performance will be assessed according to these four features (with the results in Section [TODO:]).

These four features will be reflected a model's mathematics. The less generic an optimisation model (and the higher its fidelity), the more detail with which it encodes reality. This means it will use more equations and parameters, making it less usable and tractable. As outlined in Chapter 1, the equations of optimisation models are comprised of parameters and variables, where the values of parameters are fixed, and the values of the variables are chosen during the optimisation procedure. There are different forms of equations, and these different forms require their own  methods to solve.
