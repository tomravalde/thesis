...
[TODO: Replace with new table of model construction order (and results)]
...
```{r compare-formulations, fig.height=8, fig.cap="Comparison of model formulations (outliers included). \\label{fig:comparison-outliers}"}
