...
The choice of which formulation should be carried forward is first and foremost guided by the model's purpose -- it is this which informs the priority of the four characteristics of models. The most important characteristic is generality -- the whole purpose of this thesis is to develop a method which considers the production, consumption and transport of energy, water and waste management together. In this way, it follows on from the work of @Keirstead in seeking a generic approach to urban resource modelling.
