...
where at a chosen point $P$ is the water's pressure, $z$ is its elevation with respect to a reference, and $v$ is its velocity ($g$ is the constant of acceleration due to gravity).
...
\begin{figure}
	\centering
	\sffamily
	\resizebox{0.8\columnwidth}{!}{\input{05_model-development/assemble-model.pdf_tex}}
