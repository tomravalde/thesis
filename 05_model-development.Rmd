...
Modelling is central to this thesis. Chapter 2 showed that the field of urban metabolism can be advanced by a model which considers how an area's resource management processes affect its overall metabolic flows. The particular reason this thesis is interested in such an idea, is that it may assist the high integration of resource management processes, which may yield environmental and economic benefits.  It is the purpose of this chapter to formulate a *highly integrated urban energy, water, and waste systems* optimisation model.

Once chosen, the formulated model can be applied to a case study, using the data assembled in Chapter 4, assessing the modelling results on the basis of the work in Chapter 3.
