...
OBJECTIVE_FUNCTION..
cost_total =e= sum((Z,T), exports('waste',Z,T)) + sum((Z,T), exports('biomassAgriWaste',Z,T)) + sum((Z,T), exports('digestate',Z,T)) + sum((Z,T), exports('foodWaste',Z,T)) + sum((Z,T), exports('MSW',Z,T)) + sum((Z,T), exports('vegWaste',Z,T)) + sum((Z,T), exports('slag',Z,T)) + sum((Z,T), exports('recyclables',Z,T)) + sum((Z,T), exports('waste_organic',Z,T));
