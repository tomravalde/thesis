...
In calculating emissions quantities, it is assumed that the specific $CO_2$ emissions for petrol (gasoline) is $3.3 \mbox{kg_{CO_2}/kg_{fuel}}$[^gasoline-emissions] . Therefore, per $km$ travelled by a vehicle, the emissions are given as:
