...
The data discussed in this appendix can all be found online at the GitHub repository for this thesis[^thesis-github]. Morever, because this thesis has been written using the R-markdown format, the R code used to summarise and manipulate the data is embedded in the source of this page[^appendix-source], which maybe useful for those who want to study the data for themselves.

[^thesis-github]: \url{https://github.com/tomravalde/thesis}

[^appendix-source]: \url{https://github.com/tomravalde/thesis/blob/master/app-C_data.Rmd}
...
[^zone-matrix]:\url{https://github.com/tomravalde/thesis/blob/develop/shann-gu-case-study/modelling/model/data/model-definition/zone-matrix.csv}
...
[^times]:\url{https://github.com/tomravalde/thesis/blob/develop/shann-gu-case-study/modelling/model/data/model-definition/times.csv}
...
```{r demands-summary}
library("dplyr")
demands <- read.csv("shann-gu-case-study/paper/resource-demands.csv")
...
In summary, the reasoning for every demand value which appears in the case study can be justified by the chain of sources, assumptions, and calculations embedded in the table. Below are a few rows randomly sampled from this dataset.
