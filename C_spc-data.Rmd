...
Electrical energy is lost as electricity travels along a cable, typically at a rate of about 3--7 per cent over 1,000 km[^elec-loss]. In the SPC case study, cable lengths are around 10 km, and thus losses will be assumed to be negligible, meaning that there is only a need to define parameters of -1 and 1 for $k^{\alpha}_{\tau rq}$ and $k^{\alpha'}_{\tau rq}$, respectively, and $k^{\beta}_{\tau rq} = k^{\beta'}_{\tau rq} = 0$.

[^elec-loss]: According to The Energy Technology Systems Analysis Program (see \url{http://iea-etsap.org/web/Highlights%20PDF/E12_el-t&d_KV_Apr2014_GSOK%201.pdf})
