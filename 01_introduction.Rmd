...
## The challenge of urban resource management
...
Environmental strain is a term we are giving to various negative environmental consequences which can be traced to resource use in cities. Some of these effects may be manifested within a city itself or its immediate locality, while other effects may be felt more generally:

Note the from the above listing of environmental strains, different resource types are the culprits. These different resource types can interact, as follows:
...
1. *Water and energy.* Both water and energy demands are exacerbated by population growth and economic growth (which induces a desire for improved living standards). The increase in water demands necessitates an increase in energy demands (for treatment and distribution). Furthermore, as climate change limits the availability of water in many places, energy consumption will need to increase for extracting water for human use (through desalination and other energy intensive treatment methods). It is estimated that approximately 35\% of the energy used by municipalities is for water supply and wastewater treatment [@El2005]. The increase in energy consumption will then exacerbate climate change invoking a self-reinforcing challenge [@Webber2011]. The water-energy link poses challenges in the other direction as water requirements for cooling (in power plants) increase to meet higher energy demands [@McMahon2011]. 

2. *Energy and waste.* The waste sector has a large energy consumption corresponding to transport and management processes [@ICE2011].

3. *Water and waste.* The increase in water leads to increased wastewater generation which needs to be managed through either treatment or disposal [@McMahon2011]. 
