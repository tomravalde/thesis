...
Before considering the economic and environmental challenges of urban resource management, it is important to note that global urbanisation is a trend that expected to continue. At present, urban areas are home to just over half of the global population [@UN2014]. By 2030, this figure is expected to grow to 60 per cent, and to over 65 per cent by 2050 (Figure \ref{fig:pop_forecasts}). This growth has three components: cities absorbing population growth; migration from rural areas; and the reclassification of rural areas as urban [@Cohen2006].
<!--
...
```{r pop_data, fig.height=1.8, fig.width=5, fig.cap="Global population between 1950 and 2014, and forecasts up to 2050, according to \\citet{UN2014}.\\label{fig:pop_forecasts}", results="asis"}
