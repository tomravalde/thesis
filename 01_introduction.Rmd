...
The key thing here though is that these models do not consider the different resource management systems together, and thus are not formulated to take advantage of intersectoral synergies. Nevertheless, these (and other) precedent models could be a helpful starting point for the development of an integrated model.
...
This will be considered in some detail in Chapter 2. Briefly, it makes the analogy with living organisms, that cities consume and produce goods, and this sustains their life: everything from their populations. UM relates resource flows to properties and functions of a city [@Kennedy2011]. This 'metaphorical framework' [@Pincetl2012, p.194] provides the language to analyse relationships between urban resource use and other aspects of a city, such as its form/layout, material stocks, socioeconomic characteristics, political and institutional arrangements [@Hobbes2007], activities and functions etc.

METHODS

Clearly, UM is a broad discipline, and studies will vary in their scope. But broadly, studies entail, first quantifying some set of resource flows 
...
PUNCHY STATEMENT OF THE CHALLENGE
...
\item[Process] Definition. Thus, unless qualified (e.g. 'economic processes'), 
\item[Resource] Definition.

\end{description}

The notions of systems optimisation models, and urban metabolism have been introduced [TODO:] which leads to the question of this thesis[^research-question]:

[^research-question]: This gives the study a clear focus, and provides a benchmark for assessing the success of the final outcome of the study. [TODO: Add citation] 
...
1. Research the motivation, opportunity and methods for such models for the literature review. This will bring together a study of the urban metabolism literature, a review of urban resource interactions and infrastrucures, and knowledge from existing methods used in optimising energy, water and waste management.
   	i. define what it means to improve UM
   	i. database of processes
2. Develop an optimisation model to calculate the optimal transfer of resources through a network of processes such that demand for resources of required quality is met. The models must capture the complexity of considering multiple resources and their qualities whilst remaining tractable. Three models will be developed during the term of study:
	i. Tests models applied to a small subsistence-based community, to develop an There will be no spatial or temporal disaggregation in this model, because its primary purpose is to develop a methodology which can handle multiple resource types, each of which are associated with one or more quality parameters.
