...
## The challenge of urban resource management, simply stated
...
The rest of this Introduction establishes the reality of this argument.
...
## Urban areas: the opportunity
\label{sec:urbanOpps}

The headline statistics show that compared to rural areas, that on a per capita basis, cities use more energy and water, and produce more waste. However, if quality of life is factored in (which afterall is one of the key advantages to urbanisation), it is actually the case that, on the whole, cities use less resources per capita to achieve a given quality of life. This reveals that cities are actually more efficient at delivering resources. This conclusion should be obvious from the fact urbanisation happens -- there must be some advantage after all. It is also common sense: for example less energy is required to transport goods to a population of consumer. Furthermore, this result is consistent with the urban economies of scale revealed in @Bettencourt's scaling laws. (For detailed mathematical demonstration of this, see [TODO: cite http://science.sciencemag.org/content/sci/340/6139/1438.full.pdf]. 

This urban efficiency data can be seen in a number of studies, including 
(Note exceptions.)
...
- Waste collectors see the opportunity in poorer areas (http://practicalaction.org/urban-waste-management-3)
...
If the previous section established the need for cities to manage resources better, this section establishes the opportunity, particularly in relation to systems integration.
...
[TODO: Move to UM section]

Note the from the above listing of environmental strains, different resource types are the culprits. 
