...
Urbanisation happens because over time, people tend to act in their socioeconomic self interest. Thus, people migrate from the countryside in search of employment, and better access to education, healthcare, and other services. Thus a city grows. As it does so, firms take advantage of economies of scale, and the city begins to specialise. Cities then become 'agglomeration economies'; different types of firms and industries are close to each other, facilitating knowledge spillovers, and specialisation such that firms benefit from each others' proximity. With scale and agglomeration, a city can trade its goods and services, which increases the city's prosperity. And prosperity attracts migrants. @WorldBank2008a. Thus their is a virtuous circle of urbanisation (represented in Figure \ref{fig:urbanCycle}) in which city size and economic growth feed one another.
...
Given that the mechanism which drives urbanisation is the search for prosperity, it is not surprising that their is little appetite to oppose this phenomenon. That is not to say that there are no problems, such as the widespread presence of slums. The World Bank describes these as 'growing pains', [TODO: citation, inc. page number] and notes their historical precidense in cities like London, where they are now no longer to be found. The majority of growth takes place in the developing world. (Africa and Asia will together account for 86 per cent of the increase in urban dwellers by 2050 [@York2011]). . [TODO: shift the first point here to the 'mechanism' section. Remove the second point?] It is encouraging that the urbanisation patterns seen historically in OEDC countries are being replicated in the developing world [@WorldBank2008a] (and conversely, troubling to learn that *'' ... 72\% of developing countries have adopted policies designed to stem the tide of migration to their cities.''* [@Donald2012]. In summary, urbanisation is a clear long term route to economic prosperity, confirmed by the headline statistic that 80 per cent of global GDP is generated in urban areas [@AREAS2012].
<!--
