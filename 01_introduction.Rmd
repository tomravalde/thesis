...
Whatever mix of approaches is adopted to better manage the world's resources -- whether they be behavioural, efficiency, technological, or system wide -- the need to better manage urban resources is clear by the following argument:
...
Urbanisation is a proven path to prosperity, so it is unsurprising that expert opinion their is little appetite to oppose it. That is not to say they provide an immediate solution to all issues of poverty. Cities often have a widespread presence of slums, especially at the beginning of their development. The World Bank describes these as 'growing pains', [TODO: citation, inc. page number] and notes their historical precedence in cities like London, where they are now no longer to be found. The majority of growth takes place in the developing world. (Africa and Asia will together account for 86 per cent of the increase in urban dwellers by 2050 [@York2011]). It is encouraging that the urbanisation patterns seen historically in OEDC countries are being replicated in the developing world [@WorldBank2008a] (and conversely, troubling to learn that *" ... 72\% of developing countries have adopted policies designed to stem the tide of migration to their cities.''* [@Donald2012]. In summary, urbanisation is a clear long term route to economic prosperity, confirmed by the headline statistic that 80 per cent of global GDP is generated in urban areas [@AREAS2012].
<!--
...
## Urban areas present opportunities
\label{sec:urbanOpps}
