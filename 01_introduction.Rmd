...
\item [Waste] This resource type also raises a number of issues in relation to urban areas. The primary issue is simply the volume of waste produced, which municipal governments need to deal with somehow. Urban dwellers, who want to enjoy a higher quality of life, consume more goods and services, and so generate more waste. Thus per capita waste generation rates are higher in cities than in rural areas, and with 

But secondary issues included climate change (i.e. 5 per cent of total emissions: https://www.rt.com/news/global-waste-problem-urban-garbage-429/). Others include flooding, air pollution and health impacts [TODO: \url{http://documents.worldbank.org/curated/en/302341468126264791/pdf/68135-REVISED-What-a-Waste-2012-Final-updated.pdf}], as well as smells and visual pollution are other concerns [TODO: cite \url{http://unstats.un.org/unsd/environment/envpdf/UNSD_UNEP_ECA%20Workshop/Session%2008-3%20Waste%20Statistics%20(UNSD).pdf}].
...
Summary of above issues:

The common culprit for issues outlined above is that the higher quality of life made possible by urban areas requires greater resource consumption to sustain it.

- Affluence (i.e. the driver of urbanisation) is a common issue across the three resource types:
- Water issues caused by (http://www.unwater.org/downloads/Water_facts_and_trends.pdf):

	- "increasing affluence"
	- "expansion of business activity"
	- "radpid urbanisation" (mainly an infrastructure challenge)
	- "climate change" [TODO: move to sectoral interactions]

- Note that water is different, because it does not 'run out', but distribution is a problem

### Intersectoral interactions

It is also the case that the different resource types can interact, as follows:
...
\item [Energy and water] Both water and energy demands are exacerbated by population growth and economic growth (which induces a desire for improved living standards). The increase in water demands necessitates an increase in energy demands (for treatment and distribution). Furthermore, as climate change limits the availability of water in many places, energy consumption will need to increase for extracting water for human use (through desalination and other energy intensive treatment methods). It is estimated that approximately 35\% of the energy used by municipalities is for water supply and wastewater treatment [@El2005]. The increase in energy consumption will then exacerbate climate change invoking a self-reinforcing challenge [@Webber2011]. The water-energy link poses challenges in the other direction as water requirements for cooling (in power plants) increase to meet higher energy demands [@McMahon2011]. 

\item [Energy and waste] The waste sector has a large energy consumption corresponding to transport and management processes [@ICE2011].
...
Disposing of wastewater into freshwater systems can so pollute them, that nature cannot recycle the water as quickly as it is needed, and so expensive treatments are required [TODO: cite http://www.unwater.org/downloads/Water_facts_and_trends.pdf].

General points:

- Sectoral interactions will become a major theme of this thesis [TODO: complete] 
- Climate change is both exacerbated by, and exacerbates these issues
