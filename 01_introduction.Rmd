...
SUMMARISE THE BENEFIT OF THE SYNERGIES

The dense nature of cities is such that synergies between urban infrastructures can be identified and exploited. Thus a node in a resource management network can have multiple functionalities and the waste products of one process can become the inputs to another.

Such has been practised at smaller scales: Industrial symbiosis is advocated whereby firms use each others' waste outputs as raw material inputs in other processes (e.g. production and manufacturing as well as WtE applications), in line with the 'proximity principle' observed in Japan, whereby waste is managed close to source. 

NOTE HOW IT HELPS MEET CALLS IN THE LITERATURE

REVEAL THE EXTENT OF THE COMPLEXITY

Reflecting on these intersectoral synergies, we quickly see how complicated 

Zoom out from considering just the transfer of resources between two processes, and the picture quickly gets more complicated
...
Such 'circularisation' of resources is increasingly playing a part in sustainable urban design \citep{Meijer2011}.

## Systems optimisation

TO NAVIGATE THE COMPLEXITY OF THE PROBLEM, A FORMAL MODELLING APPROACH
...
Here, we return to a theme introduced earlier: the idea of a 'system', which can be formally represented mathematically 

Brief summary of the mathematics/optimisation

The possibility is there. The question is, how can it be implemented (at least the engineering aspects)?
...
Comment that this is a good starting point for an integrated model

## Urban metabolism -- the theoretical framework

Thus far, this thesis has considered 

Any discourse on the sustainability of urban resource maangement should interact with the concept of 'urban metabolism' (UM).

Closely related to the field of urban sustainability

This will be considered in some detail in Chapter 2.
By analogy with living organqisms, UM can be seens as an attempt to syunthesis various aspects of urban resource use

Indeed, most of what has been discussed so far [TODO: continue] 

Brings together what could be a fragmented study: Studying urban resource management is potentially a fragmented collection of study areas (where different resources are siloed into separate fields, where consumption is seen in isolation to urban form and functions, where [TODO: etc.]). So it is helpful that a field has grown up which to some extent merges these considerations. Thus UM studies can answer questions like:
...
At its most stripped down, a UM study is a simple accounting exercise, to quantify the energy, water, materials, waste, and other resources [TODO: continue] 
