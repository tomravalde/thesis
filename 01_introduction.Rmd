...
\item [Energy and water] Synergies in this pairing include hydroelectric power which converts water's hydrostatic and dynamic energy into electrical energy; and water source heat pumps, which extract the heat energy stored in water. If an 'integrated water system' is designed and operated correctly, it is possible to improve both water consumption and energy efficiency \citep{Makropoulos2008}.
...
Energy savings can also be made indirectly through this link, by reusing or recycling waste, and thus reducing the energy required to manufacture new goods \citep{Geng2010}. Another indirect saving comes by way of wastewater reclamation, which can reduce overall water system energy requirements (by reducing the need to treat and distribute freshwater from scratch) \citet{Lundin2000}.
...
This is what \citet{Leduc2010} refers to as the 'urban harvest' approach, which takes advantage of connectivity and proximity in cities to maximise the reuse of water, waste and other materials within an urban system, and the cascading of energy through multiple uses in order to 'close' cycles.
