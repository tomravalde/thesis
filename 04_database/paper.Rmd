...
date: \VCDateISO
abstract:
  "In view of urbanisation trends coupled with the challenge of climate change, it is increasingly important to establish less harmful ways of urban living. To date, urban metabolism studies have quantified the aggregate material and energy flows into and out of cities, and furthermore have identified how consumer activity causes these flows. However, little attention has been paid to the networks of conversion processes that link consumer end-use demands to aggregate metabolic flows. Here, we conduct a systematic literature search to assemble a database of 202 energy, water and waste management processes. We show how the database can help planners and policy makers identify the preferred process for a given purpose, and choose the optimal mix of processes to take advantage of the synergies possible within networks of processes. The database is published as open data, so the research community can contribute and use it in conjunction with other complimentary datasets within industrial ecology."

keywords: "urban metabolism, sustainability, open data, to be completed"
---
