...
data$stat <- factor(data$stat_name,
				 levels=c("Equations", "Variables (single)", "Variables (discrete)", "Objective value [USD]", "Objective value (outliers removed) [USD]", "Solution time [s]", "Solution time (outliers removed) [s]"))
