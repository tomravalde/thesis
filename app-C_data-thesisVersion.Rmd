...
These pages provide further detail on the data used in the case study outlined in the Shann Gu Power Company (SPC) case study in Chapter 6 of *Highly integrated urban energy, water and waste resources*, including:

- summaries of the data
- links to the full data sets (recorded in CSV and YAML formats)
- notes regarding data sources, along with assumptions and calculations (e.g. those used to convert the data into appropriate units of measurement)
