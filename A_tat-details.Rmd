# Model formulation {#sec:app-model-formulation}
...
## Explaining the difference between the models with reference to a pipe, pump and dam system {#sec:pipe-pump-damn}

show in Figure \ref{fig:pump-dam-example} which represents conversion and transport processes, and further explained later in this Section. 
