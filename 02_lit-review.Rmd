...
Such an approach is somewhat arbitrary (and perhaps even limiting -- see Further Work, in Chapter 7), but it helps define the boundaries of the research, and makes a manageable piece of work for this thesis. i.e. not including the manufacturing sector (e.g. demands for iron and steel, process industries etc.), land-use models, or traffic models
