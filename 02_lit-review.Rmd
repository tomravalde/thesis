...
\begin{figure}
	...
	\caption{Non-integrated modelling only optimises how to meet the demand of one system (represented by squares).}
	\label{fig:interation-none}
	\end{subfigure}

  	\begin{subfigure}[b]{0.25\textwidth}
        \includegraphics{02_lit-review/integrated.pdf}
	\caption{Integrated modelling optimises how to meet the demand of one system (represented by the squares), but in doing so, describes more than one system (represented squares and circles).}
	\label{fig:interation-medium}
	\end{subfigure}

  	\begin{subfigure}[b]{0.25\textwidth}
        \includegraphics{02_lit-review/highly-integrated.pdf}
	\caption{Highly-integrated modelling optimises how to meet the demand of more than one system (represented squares and circles).}
