...
This chapter takes a closer look at the fields of urban metabolism and optimisation modelling, in order to identify how the UM optimisation model developed in develops previous work in these fields, and meets gaps in the existing research. Section [TODO:] gives an overview of how the UM field has been used to better understand how cities use resources, and in particular notes developments in UM research most relevant to this thesis. Section [TODO:] provides an introduction to the idea of 'modelling' and starts to make a case for how modelling can inform UM research. Finally, section [TODO:] looks in more detail at the types of models used in resource management modelling, in order to identify both the need for an integrated resource management model, and the methods by which such a model can be constructed.
