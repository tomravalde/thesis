...
Parts of this chapter have been adapted from publications: [TODO: complete] 
...
As a vehicle to explore the issues of public resource management in cities, Wolman quantified the material and energy inputs and outputs of a hypothetical city of one million inhabitants. This kind of accounting exercise is typically the fundamental starting point of UM studies. [TODO: add note on MFA and EFA]. Note here in Wolman's seminal work, are the two key elements typical of UM studies: first, the quantification of urban resource flows; second, some assessment of how these flows relate to other aspects of the city -- in Wolman's case, this was the challenges of "public economic" (p.156) decision making.
...
[TODO: Note on how this covers models more generally than mathematical optimisation]
...
All the various types of models are used to (defined in Section [TODO:]) are all to be found in resource optimisation modelling. Concrete models are often used to find the optimal paramters and conditions for running some process (e.g. anaerobic digestion) -- these are in the form of laboratory experiments or scaled-down versions of a plant. These concrete models can be coupled with statistical techniques to help find the most optimal
...
[TODO: Add detail aesthetic to the plot, following another pass through the literature?]
...
\begin{figure}
	...
	\end{subfigure}
  	...
  	\begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=0.5\textwidth]{02_lit-review/integrated.pdf}
	\caption{Integrated modelling.}
	\label{fig:interation-medium}
	\end{subfigure}

  	\begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=0.5\textwidth]{02_lit-review/highly-integrated.pdf}
