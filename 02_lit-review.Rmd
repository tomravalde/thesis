...
This chapter reviews two key bodies of research to investigate the gaps in the literature in regards to the research question (Section \ref{sec:research-qn}). The first subject of exploration shows how the UM field has developed to better understand issues or urban resource management, and identifies how UM concepts should be further developed so it is equipped to address the concern of this thesis, namely how resource management processes affect an area's metabolism. The second introduces the various ways modelling has been used to optimise the performance of resource management systems. The work described in this chapter feeds into the first aim of the research question.
...
\begin{figure}
	...
	\caption{Non-integrated modelling only considers one system (represented by squares) and it's demands.}
	\label{fig:interation-none}
	\end{subfigure}

  	\begin{subfigure}{0.8\textwidth}
        \includegraphics{02_lit-review/integrated.pdf}
	\caption{Integrated modelling considers multiple systems (represented squares and circles), but only considers meeting demands of one system.}
	\label{fig:interation-medium}
	\end{subfigure}

  	\begin{subfigure}{0.8\textwidth}
        \includegraphics{02_lit-review/highly-integrated.pdf}
	\caption{Highly-integrated modelling considers multiple systems (represented squares and circles), and how to meet the demands of both systems.}
