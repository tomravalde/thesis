...
The main aim of this thesis is to build a model which can assist planners and decision makers in improving the urban metabolism of an area. It is first necessary to examine the research areas to which this thesis addresses and thus identify the ideas, concepts, prinicples and methods upon which this work can be based, as well as highlighting the gaps in the literature, and thereby demonstrate the novelty of the work presented in subsequent chapters.

To that end, this chapter begins in Section [TODO:] by taking a closer look at the UM concept, showing how it has been used to provide to better understand how cities use resources, and in particular notes developments in UM research most relevant to this thesis. Section [TODO:] then introduces to the idea of 'modelling' in order to make the case that modelling can play an useful role in UM research. Finally, section [TODO:] looks in more detail at the types of models used in resource management modelling, in order to identify both the need for an integrated resource management model, and the methods by which such a model can be constructed.
...
## Transition section to modelling
