...
The resource management optimisation models in our filtered list have been classified according to their level of integration, and Figure \ref{fig:model-integration} plots each model as a point, located according to its scale and integration.
