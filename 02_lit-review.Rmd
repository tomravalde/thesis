...
Each of the model types above are to be found in the UM literature. Indeed, the idea of 'metabolism' is itself a descriptive model, i.e. the concept of 'metabolism' has inherent to it the fact that resource flows relate to an entity's form and function. To show where this thesis can fit within the UM modelling landscape, this section reviews the literature found by exploring the Scopus database using the search term `urban metabolism AND model OR modelling`\footnote{The full search term is available at \url{[TODO: URL]} This search excludes irrelevant subject areas (such as medicine).}

<!--
https://www.scopus.com/results/results.uri?sort=plf-f&src=s&st1=urban+metabolism+AND+model+OR+modelling&sid=E0C49FA0042774D044085C15DE330D78.f594dyPDCy4K3aQHRor6A%3a110&sot=b&sdt=cl&cluster=scosubjabbr%2c"MEDI"%2cf%2c"BIOC"%2cf%2c"PHAR"%2cf%2c"NURS"%2cf%2c"CHEM"%2cf%2c"NEUR"%2cf%2c"IMMU"%2cf%2c"MATH"%2cf%2c"BUSI"%2cf%2c"ARTS"%2cf%2c"PSYC"%2cf%2c"HEAL"%2cf%2c"MULT"%2cf%2c"VETE"%2cf%2c"Undefined"%2cf&sessionSearchId=E0C49FA0042774D044085C15DE330D78.f594dyPDCy4K3aQHRor6A%3a110&origin=savedSearchNewOnly&txGid=0}.
-->
...
As explained above, the concept UM itself is a descriptive model. By appropriating the language of real biological systems to explain urban resource flows. The concept has grown from Wolman's first study which considered simply the flows of resources, and the challenges of their public management. One such development of the concept is that of @Newman1999a, who proposes the 'Extended Metabolism Model of the City' (p.220), who adds 'livability' to encourage researchers to consider how resource flows relate health, incomes, housing stock, and other aspects of urban living. Other descriptive models are highlighted by @Zhang2013, extend the conceptualisation of how metabolic flows are considered: @Girardet1990 incorporates the recycling of resource outputs as inputs, and @Zhang2009b asks modellers to consider how resources flow between sectors within the urban boundary.

Moving beyond the conceptual models, various types of mathematical models have been developed to understand urban resources. An example of a statistical model is that of \citet{Liang2014} who find a statistical relationship between the level of a city's nighttime lighting (as measured by satellite observations) and the city's steel stock, making it possible to predict the latter from the former. \citet{Kellet2013} provides an example of a simulation model, in which a city's emissions are quantified from equations which calculate the contributions from building, transport, human, and vegetation sources. Finally, an optimisation model is put forward by \citet{Pederson2013} who use heuristics to 'evolve' optimised city designs, through new building envelopes, road networks, public spaces etc. according to the metabolic capabilities and limitations.
...
Each of the 108 papers captured in the search and filtering of the UM modelling literature are plotted as a point on Figure \ref{fig:UM-model-lit}. The point is coloured according to the model **type**, while its **focus** and **level** is represented by its location. The models cited above are labelled on the plot.
